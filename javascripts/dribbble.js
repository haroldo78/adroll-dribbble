...
(function() {
  ...
  $(document).ready(function() {
    ...
    app.popular = new Collections.Pictures({}, {
      list: 'popular'
    });
    app.debuts = new Collections.Pictures({}, {
      list: 'debuts'
    });
    app.everyone = new Collections.Pictures({}, {
      list: 'everyone'
    });
    app.addRegions({
      nav: '#nav',
    ...
    app.popularView = new Views.Pictures({
      collection: app.popular
    });
    app.popular.fetch();
    app.debutsView = new Views.Pictures({
      collection: app.debuts
    });
    app.debuts.fetch();
    app.everyoneView = new Views.Pictures({
      collection: app.everyone
    });
    app.everyone.fetch();
